...
> Concepts > Retrieval > Embedding > What Are Embeddings.Md

## Overview

This section covers what are embeddings in the context of embedding models.
...
What Are Embeddings involves several important considerations:
...
```python
from platform import what_are_embeddings

# Initialize the component
component = what_are_embeddings.create(config)
