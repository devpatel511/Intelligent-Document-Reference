...
sidebar_position: 19
tags: ["guide", "concept", "tutorial"]
---

# Model Comparison

> Concepts > Retrieval > Embedding > Model Comparison.Md

## Overview

This section covers model comparison in the context of retrieval-augmented generation.
...
Model Comparison involves several important considerations:
...
```python
from platform import model_comparison

# Initialize the component
component = model_comparison.create(config)
