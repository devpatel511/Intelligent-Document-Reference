...
> Concepts > Retrieval > Embedding > Fine Tuning.Md

## Overview

This section covers fine tuning in the context of document parsing.
...
Fine Tuning involves several important considerations:
...
```python
from platform import fine_tuning

# Initialize the component
component = fine_tuning.create(config)
