...
> Concepts > Retrieval > Chunking > Semantic Chunking.Md

## Overview

This section covers semantic chunking in the context of embedding models.
...
Semantic Chunking involves several important considerations:
...
```python
from platform import semantic_chunking

# Initialize the component
component = semantic_chunking.create(config)
