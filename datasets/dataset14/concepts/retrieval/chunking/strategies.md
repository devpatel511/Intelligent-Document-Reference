...
> Concepts > Retrieval > Chunking > Strategies.Md

## Overview

This section covers strategies in the context of knowledge graphs.
...
```python
from platform import strategies

# Initialize the component
component = strategies.create(config)
