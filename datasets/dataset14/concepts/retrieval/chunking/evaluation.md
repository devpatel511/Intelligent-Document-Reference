...
> Concepts > Retrieval > Chunking > Evaluation.Md

## Overview

This section covers evaluation in the context of embedding models.
...
Evaluation involves several important considerations:
...
```python
from platform import evaluation

# Initialize the component
component = evaluation.create(config)
