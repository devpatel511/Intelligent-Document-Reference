...
> Concepts > Retrieval > Search > Hybrid Search.Md

## Overview

This section covers hybrid search in the context of knowledge graphs.
...
Hybrid Search involves several important considerations:
...
```python
from platform import hybrid_search

# Initialize the component
component = hybrid_search.create(config)
