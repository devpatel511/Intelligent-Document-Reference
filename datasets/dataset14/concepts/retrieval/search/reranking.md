...
> Concepts > Retrieval > Search > Reranking.Md

## Overview

This section covers reranking in the context of retrieval-augmented generation.
...
Reranking involves several important considerations:
...
```python
from platform import reranking

# Initialize the component
component = reranking.create(config)
