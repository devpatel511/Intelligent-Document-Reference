...
> Concepts > Ingestion > Preprocessing > Language Detection.Md

## Overview

This section covers language detection in the context of multi-modal indexing.
...
Language Detection involves several important considerations:
...
```python
from platform import language_detection

# Initialize the component
component = language_detection.create(config)
