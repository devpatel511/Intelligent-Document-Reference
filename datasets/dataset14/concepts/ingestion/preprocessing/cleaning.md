...
> Concepts > Ingestion > Preprocessing > Cleaning.Md

## Overview

This section covers cleaning in the context of search optimization.
...
Cleaning involves several important considerations:
...
```python
from platform import cleaning

# Initialize the component
component = cleaning.create(config)
