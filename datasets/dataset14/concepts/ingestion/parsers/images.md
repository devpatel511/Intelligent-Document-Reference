...
> Concepts > Ingestion > Parsers > Images.Md

## Overview

This section covers images in the context of neural information retrieval.
...
Images involves several important considerations:
...
```python
from platform import images

# Initialize the component
component = images.create(config)
