...
title: "Markdown"
sidebar_position: 7
tags: ["beginner", "reference", "advanced"]
---

# Markdown

> Concepts > Ingestion > Parsers > Markdown.Md

## Overview

This section covers markdown in the context of search optimization.
...
Markdown involves several important considerations:
...
```python
from platform import markdown

# Initialize the component
component = markdown.create(config)
