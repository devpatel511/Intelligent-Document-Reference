...
> Concepts > Ingestion > Parsers > Html.Md

## Overview

This section covers html in the context of embedding models.
...
Html involves several important considerations:
...
```python
from platform import html

# Initialize the component
component = html.create(config)
