...
> Concepts > Ingestion > Parsers > Docx.Md

## Overview

This section covers docx in the context of embedding models.
...
Docx involves several important considerations:
...
```python
from platform import docx

# Initialize the component
component = docx.create(config)
