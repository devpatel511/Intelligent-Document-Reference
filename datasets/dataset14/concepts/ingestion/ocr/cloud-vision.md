...
title: "Cloud Vision"
sidebar_position: 11
tags: ["beginner", "guide", "reference"]
---

# Cloud Vision

> Concepts > Ingestion > Ocr > Cloud Vision.Md

## Overview

This section covers cloud vision in the context of chunking strategies.
...
Cloud Vision involves several important considerations:
...
```python
from platform import cloud_vision

# Initialize the component
component = cloud_vision.create(config)
