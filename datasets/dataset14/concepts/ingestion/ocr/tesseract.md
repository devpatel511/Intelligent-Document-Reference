...
> Concepts > Ingestion > Ocr > Tesseract.Md

## Overview

This section covers tesseract in the context of retrieval-augmented generation.
...
Tesseract involves several important considerations:
...
```python
from platform import tesseract

# Initialize the component
component = tesseract.create(config)
