...
> Concepts > Ingestion > Ocr > Accuracy.Md

## Overview

This section covers accuracy in the context of chunking strategies.
...
Accuracy involves several important considerations:
...
```python
from platform import accuracy

# Initialize the component
component = accuracy.create(config)
