...
> Reference > Sdk > Javascript > Client.Md

## Overview

This section covers client in the context of neural information retrieval.
...
Client involves several important considerations:
...
component = client.create(config)
