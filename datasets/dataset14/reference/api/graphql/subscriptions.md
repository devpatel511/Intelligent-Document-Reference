...
title: "Subscriptions"
sidebar_position: 19
tags: ["advanced", "beginner", "guide"]
---

# Subscriptions

> Reference > Api > Graphql > Subscriptions.Md

## Overview

This section covers subscriptions in the context of chunking strategies.
...
- Basic understanding of chunking strategies
...
Subscriptions involves several important considerations:
...
```python
from platform import subscriptions

# Initialize the component
component = subscriptions.create(config)
...
| Poor quality | Wrong model | Try a different chunking strategies model |
