...
> Reference > Api > Graphql > Schema.Md

## Overview

This section covers schema in the context of vector databases.
...
Schema involves several important considerations:
...
```python
from platform import schema

# Initialize the component
component = schema.create(config)
