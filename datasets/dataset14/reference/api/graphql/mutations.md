...
> Reference > Api > Graphql > Mutations.Md

## Overview

This section covers mutations in the context of search optimization.
...
Mutations involves several important considerations:
...
```python
from platform import mutations

# Initialize the component
component = mutations.create(config)
