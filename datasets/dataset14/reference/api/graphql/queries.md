...
title: "Queries"
sidebar_position: 8
tags: ["api", "concept", "guide"]
---

# Queries

> Reference > Api > Graphql > Queries.Md

## Overview

This section covers queries in the context of retrieval-augmented generation.
...
Queries involves several important considerations:
...
```python
from platform import queries

# Initialize the component
component = queries.create(config)
