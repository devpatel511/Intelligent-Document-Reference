...
> Reference > Api > Rest > Settings.Md

## Overview

This section covers settings in the context of neural information retrieval.
...
Settings involves several important considerations:
...
component = settings.create(config)
