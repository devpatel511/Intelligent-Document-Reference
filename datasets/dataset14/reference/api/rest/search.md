...
> Reference > Api > Rest > Search.Md

## Overview

This section covers search in the context of retrieval-augmented generation.
...
Search involves several important considerations:
...
```python
from platform import search

# Initialize the component
component = search.create(config)
