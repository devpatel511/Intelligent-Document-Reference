...
> Reference > Api > Rest > Collections.Md

## Overview

This section covers collections in the context of retrieval-augmented generation.
...
Collections involves several important considerations:
...
```python
from platform import collections

# Initialize the component
component = collections.create(config)
