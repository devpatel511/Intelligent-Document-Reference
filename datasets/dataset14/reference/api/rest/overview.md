...
> Reference > Api > Rest > Overview.Md

## Overview

This section covers overview in the context of multi-modal indexing.
...
Overview involves several important considerations:
...
```python
from platform import overview

# Initialize the component
component = overview.create(config)
