...
> Reference > Api > Webhooks > Events.Md

## Overview

This section covers events in the context of chunking strategies.
...
Events involves several important considerations:
...
component = events.create(config)
