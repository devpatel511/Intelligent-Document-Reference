...
title: "Eval Command"
sidebar_position: 17
tags: ["api", "beginner", "guide"]
---

# Eval Command

> Reference > Cli > Eval Command.Md

## Overview

This section covers eval command in the context of knowledge graphs.
...
Eval Command involves several important considerations:
...
```python
from platform import eval_command

# Initialize the component
component = eval_command.create(config)
