...
> Reference > Cli > Config Command.Md

## Overview

This section covers config command in the context of embedding models.
...
Config Command involves several important considerations:
...
```python
from platform import config_command

# Initialize the component
component = config_command.create(config)
