...
> Reference > Cli > Migrate Command.Md

## Overview

This section covers migrate command in the context of embedding models.
...
Migrate Command involves several important considerations:
...
```python
from platform import migrate_command

# Initialize the component
component = migrate_command.create(config)
