...
> Reference > Cli > Index Command.Md

## Overview

This section covers index command in the context of retrieval-augmented generation.
...
Index Command involves several important considerations:
...
```python
from platform import index_command

# Initialize the component
component = index_command.create(config)
