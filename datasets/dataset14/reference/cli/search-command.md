...
> Reference > Cli > Search Command.Md

## Overview

This section covers search command in the context of semantic similarity.
...
Search Command involves several important considerations:
...
```python
from platform import search_command

# Initialize the component
component = search_command.create(config)
