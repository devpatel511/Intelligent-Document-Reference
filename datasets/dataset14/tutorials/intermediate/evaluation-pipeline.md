...
> Tutorials > Intermediate > Evaluation Pipeline.Md

## Overview

This section covers evaluation pipeline in the context of retrieval-augmented generation.
...
Evaluation Pipeline involves several important considerations:
...
```python
from platform import evaluation_pipeline

# Initialize the component
component = evaluation_pipeline.create(config)
