...
> Tutorials > Intermediate > Multi Modal.Md

## Overview

This section covers multi modal in the context of neural information retrieval.
...
Multi Modal involves several important considerations:
...
```python
from platform import multi_modal

# Initialize the component
component = multi_modal.create(config)
