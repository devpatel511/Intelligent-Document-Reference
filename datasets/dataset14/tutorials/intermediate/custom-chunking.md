...
> Tutorials > Intermediate > Custom Chunking.Md

## Overview

This section covers custom chunking in the context of document parsing.
...
Custom Chunking involves several important considerations:
...
```python
from platform import custom_chunking

# Initialize the component
component = custom_chunking.create(config)
