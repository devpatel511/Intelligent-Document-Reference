...
> Tutorials > Beginner > First Index.Md

## Overview

This section covers first index in the context of knowledge graphs.
...
First Index involves several important considerations:
...
```python
from platform import first_index

# Initialize the component
component = first_index.create(config)
