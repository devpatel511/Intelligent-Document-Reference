...
> Tutorials > Beginner > Adding Documents.Md

## Overview

This section covers adding documents in the context of multi-modal indexing.
...
Adding Documents involves several important considerations:
...
```python
from platform import adding_documents

# Initialize the component
component = adding_documents.create(config)
