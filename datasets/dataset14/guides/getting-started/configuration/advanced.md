...
> Guides > Getting Started > Configuration > Advanced.Md

## Overview

This section covers advanced in the context of vector databases.
...
Advanced involves several important considerations:
...
```python
from platform import advanced

# Initialize the component
component = advanced.create(config)
