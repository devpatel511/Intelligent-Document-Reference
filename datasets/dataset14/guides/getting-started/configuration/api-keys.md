...
> Guides > Getting Started > Configuration > Api Keys.Md

## Overview

This section covers api keys in the context of neural information retrieval.
...
Api Keys involves several important considerations:
...
```python
from platform import api_keys

# Initialize the component
component = api_keys.create(config)
