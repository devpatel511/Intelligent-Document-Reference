...
> Guides > Getting Started > Configuration > Database.Md

## Overview

This section covers database in the context of search optimization.
...
Database involves several important considerations:
...
component = database.create(config)
