...
> Guides > Getting Started > Installation > Docker.Md

## Overview

This section covers docker in the context of multi-modal indexing.
...
Docker involves several important considerations:
...
```python
from platform import docker

# Initialize the component
component = docker.create(config)
