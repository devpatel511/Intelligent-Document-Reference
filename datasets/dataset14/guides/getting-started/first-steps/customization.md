...
title: "Customization"
sidebar_position: 7
tags: ["advanced", "tutorial", "guide"]
---

# Customization

> Guides > Getting Started > First Steps > Customization.Md

## Overview

This section covers customization in the context of search optimization.
...
- Basic understanding of search optimization
...
Customization involves several important considerations:
...
```python
from platform import customization

# Initialize the component
component = customization.create(config)
...
| Poor quality | Wrong model | Try a different search optimization model |
