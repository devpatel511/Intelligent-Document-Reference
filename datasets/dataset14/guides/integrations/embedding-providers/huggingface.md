...
> Guides > Integrations > Embedding Providers > Huggingface.Md

## Overview

This section covers huggingface in the context of neural information retrieval.
...
Huggingface involves several important considerations:
...
```python
from platform import huggingface

# Initialize the component
component = huggingface.create(config)
