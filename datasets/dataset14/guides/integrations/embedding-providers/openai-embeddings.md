...
sidebar_position: 1
tags: ["reference", "tutorial", "advanced"]
---

# Openai Embeddings

> Guides > Integrations > Embedding Providers > Openai Embeddings.Md

## Overview

This section covers openai embeddings in the context of document parsing.
...
Openai Embeddings involves several important considerations:
...
```python
from platform import openai_embeddings

# Initialize the component
component = openai_embeddings.create(config)
