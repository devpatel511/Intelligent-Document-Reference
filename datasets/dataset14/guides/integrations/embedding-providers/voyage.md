...
> Guides > Integrations > Embedding Providers > Voyage.Md

## Overview

This section covers voyage in the context of chunking strategies.
...
Voyage involves several important considerations:
...
```python
from platform import voyage

# Initialize the component
component = voyage.create(config)
