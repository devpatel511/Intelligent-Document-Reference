...
> Guides > Integrations > Embedding Providers > Cohere.Md

## Overview

This section covers cohere in the context of chunking strategies.
...
Cohere involves several important considerations:
...
```python
from platform import cohere

# Initialize the component
component = cohere.create(config)
