...
> Guides > Integrations > Llm Providers > Anthropic.Md

## Overview

This section covers anthropic in the context of multi-modal indexing.
...
Anthropic involves several important considerations:
...
```python
from platform import anthropic

# Initialize the component
component = anthropic.create(config)
