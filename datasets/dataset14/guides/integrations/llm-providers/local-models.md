...
> Guides > Integrations > Llm Providers > Local Models.Md

## Overview

This section covers local models in the context of search optimization.
...
Local Models involves several important considerations:
...
```python
from platform import local_models

# Initialize the component
component = local_models.create(config)
