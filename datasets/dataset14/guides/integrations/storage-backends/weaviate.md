...
title: "Weaviate"
sidebar_position: 1
tags: ["concept", "beginner", "api"]
---

# Weaviate

> Guides > Integrations > Storage Backends > Weaviate.Md

## Overview

This section covers weaviate in the context of multi-modal indexing.
...
Weaviate involves several important considerations:
...
```python
from platform import weaviate

# Initialize the component
component = weaviate.create(config)
