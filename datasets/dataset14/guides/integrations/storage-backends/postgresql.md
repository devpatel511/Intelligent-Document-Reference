...
> Guides > Integrations > Storage Backends > Postgresql.Md

## Overview

This section covers postgresql in the context of vector databases.
...
Postgresql involves several important considerations:
...
```python
from platform import postgresql

# Initialize the component
component = postgresql.create(config)
