...
> Guides > Advanced > Deployment > Self Hosted > Bare Metal.Md

## Overview

This section covers bare metal in the context of embedding models.
...
Bare Metal involves several important considerations:
...
```python
from platform import bare_metal

# Initialize the component
component = bare_metal.create(config)
