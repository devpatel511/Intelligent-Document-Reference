...
title: "Kubernetes"
sidebar_position: 12
tags: ["tutorial", "beginner", "concept"]
---

# Kubernetes

> Guides > Advanced > Deployment > Self Hosted > Kubernetes.Md

## Overview

This section covers kubernetes in the context of neural information retrieval.
...
Kubernetes involves several important considerations:
...
```python
from platform import kubernetes

# Initialize the component
component = kubernetes.create(config)
