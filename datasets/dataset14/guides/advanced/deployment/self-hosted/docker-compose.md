...
> Guides > Advanced > Deployment > Self Hosted > Docker Compose.Md

## Overview

This section covers docker compose in the context of chunking strategies.
...
Docker Compose involves several important considerations:
...
```python
from platform import docker_compose

# Initialize the component
component = docker_compose.create(config)
