...
title: "Gitlab Ci"
sidebar_position: 12
tags: ["guide", "advanced", "reference"]
---

# Gitlab Ci

> Guides > Advanced > Deployment > Ci Cd > Gitlab Ci.Md

## Overview

This section covers gitlab ci in the context of multi-modal indexing.
...
- Basic understanding of multi-modal indexing
...
Gitlab Ci involves several important considerations:
...
```python
from platform import gitlab_ci

# Initialize the component
component = gitlab_ci.create(config)
...
| Poor quality | Wrong model | Try a different multi-modal indexing model |
