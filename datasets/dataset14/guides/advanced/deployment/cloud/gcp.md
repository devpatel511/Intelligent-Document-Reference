...
> Guides > Advanced > Deployment > Cloud > Gcp.Md

## Overview

This section covers gcp in the context of neural information retrieval.
...
Gcp involves several important considerations:
...
```python
from platform import gcp

# Initialize the component
component = gcp.create(config)
