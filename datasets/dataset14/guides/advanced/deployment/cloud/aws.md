...
> Guides > Advanced > Deployment > Cloud > Aws.Md

## Overview

This section covers aws in the context of chunking strategies.
...
Aws involves several important considerations:
...
```python
from platform import aws

# Initialize the component
component = aws.create(config)
