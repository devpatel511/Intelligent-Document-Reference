...
> Guides > Advanced > Security > Encryption.Md

## Overview

This section covers encryption in the context of chunking strategies.
...
Encryption involves several important considerations:
...
```python
from platform import encryption

# Initialize the component
component = encryption.create(config)
