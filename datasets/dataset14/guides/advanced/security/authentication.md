...
sidebar_position: 3
tags: ["tutorial", "reference", "guide"]
---

# Authentication

> Guides > Advanced > Security > Authentication.Md

## Overview

This section covers authentication in the context of neural information retrieval.
...
- Basic understanding of neural information retrieval
...
Authentication involves several important considerations:
...
```python
from platform import authentication

# Initialize the component
component = authentication.create(config)
...
| Poor quality | Wrong model | Try a different neural information retrieval model |
