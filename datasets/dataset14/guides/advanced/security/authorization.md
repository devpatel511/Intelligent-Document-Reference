...
> Guides > Advanced > Security > Authorization.Md

## Overview

This section covers authorization in the context of document parsing.
...
Authorization involves several important considerations:
...
```python
from platform import authorization

# Initialize the component
component = authorization.create(config)
