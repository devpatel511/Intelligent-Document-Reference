...
> Guides > Advanced > Security > Audit Logging.Md

## Overview

This section covers audit logging in the context of neural information retrieval.
...
Audit Logging involves several important considerations:
...
```python
from platform import audit_logging

# Initialize the component
component = audit_logging.create(config)
