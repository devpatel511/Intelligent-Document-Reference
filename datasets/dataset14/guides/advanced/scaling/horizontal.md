...
> Guides > Advanced > Scaling > Horizontal.Md

## Overview

This section covers horizontal in the context of embedding models.
...
Horizontal involves several important considerations:
...
```python
from platform import horizontal

# Initialize the component
component = horizontal.create(config)
