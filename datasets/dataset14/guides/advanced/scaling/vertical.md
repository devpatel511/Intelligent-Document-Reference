...
> Guides > Advanced > Scaling > Vertical.Md

## Overview

This section covers vertical in the context of multi-modal indexing.
...
Vertical involves several important considerations:
...
```python
from platform import vertical

# Initialize the component
component = vertical.create(config)
