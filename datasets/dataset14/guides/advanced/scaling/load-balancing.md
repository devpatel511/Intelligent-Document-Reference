...
> Guides > Advanced > Scaling > Load Balancing.Md

## Overview

This section covers load balancing in the context of neural information retrieval.
...
Load Balancing involves several important considerations:
...
```python
from platform import load_balancing

# Initialize the component
component = load_balancing.create(config)
