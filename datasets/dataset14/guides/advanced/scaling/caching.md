...
> Guides > Advanced > Scaling > Caching.Md

## Overview

This section covers caching in the context of neural information retrieval.
...
Caching involves several important considerations:
...
```python
from platform import caching

# Initialize the component
component = caching.create(config)
